...
QUnit.module("web_enterprise", function ({ beforeEach }) {
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            assert.strictEqual(
                target.querySelector(".oe_instance_register").innerText,
                "Your subscription expired 5 days ago. This database will be blocked soon. Register your subscription or buy a subscription."
            );
...
Send an email to the subscription owner to confirm the change, enter a new code or buy a subscription.`
    ...
    QUnit.test("One app installed, upgrade database", async function (assert) {
        ...
        assert.strictEqual(
            target.querySelector(".oe_instance_register").innerText,
            "Your subscription expired 10 days ago. This database will be blocked soon. You have more users or more apps installed than your subscription allows.\n\n" +
